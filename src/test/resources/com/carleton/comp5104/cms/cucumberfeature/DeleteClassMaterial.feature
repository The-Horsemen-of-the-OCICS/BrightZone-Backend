@tag
Feature: As a Professor I want to delete course material(e.g. slides, assignment files, etc) from my class
  ...
  Scenario Outline: Professor uploads a file successfully.
    ...
    When The professor delete the file with filename <file_name> under directory <dir> from class <class_id>
    Then The file file with filename <file_name> under directory <dir> from class <class_id> is deleted
